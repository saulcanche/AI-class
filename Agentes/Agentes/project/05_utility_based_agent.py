#!/usr/bin/env python3
"""Program 5: utility-based agent in the Wumpus world."""
...
from agents.utility_based import UtilityBasedAgent  # noqa: E402
from wumpus.environment import WumpusWorld  # noqa: E402


def main() -> None:
    parser = build_parser("Utility-based agent (gold vs death vs steps) in the Wumpus world.")
    args = parser.parse_args()
    config = load_world_config(args)
    world = WumpusWorld(config)
    agent = UtilityBasedAgent(config)
